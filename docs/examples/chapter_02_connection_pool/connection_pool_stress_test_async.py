#!/usr/bin/env python3
"""
Example: MySQL Connection Pool Stress Test (Asynchronous)
...
Run with: .venv_mysql\Scripts\python connection_pool_stress_test_async.py
...
async def main():
    ...
    print("=" * 70)
    print("MySQL Connection Pool Stress Test (Asynchronous)")
    print("=" * 70)
    ...
    try:
        ...
        config = PoolConfig(
            ...
            backend_factory=lambda: AsyncMySQLBackend(**mysql_config)
        )
