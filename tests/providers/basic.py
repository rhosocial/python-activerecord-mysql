...
class BasicProvider(IBasicProvider):
    ...
    def setup_user_fixtures(self, scenario_name: str) -> Tuple[Type[ActiveRecord], ...]:
    ...
    def setup_type_case_fixtures(self, scenario_name: str) -> Tuple[Type[ActiveRecord], ...]:
    ...
    def setup_validated_user_fixtures(self, scenario_name: str) -> Tuple[Type[ActiveRecord], ...]:
    ...
    def setup_validated_field_user_fixtures(self, scenario_name: str) -> Tuple[Type[ActiveRecord], ...]:
        ...
        models_and_tables = [
            (ValidatedFieldUser, "validated_field_users"),
        ]
    ...
    def setup_type_test_fixtures(self, scenario_name: str) -> Tuple[Type[ActiveRecord], ...]:
        """Sets up the database for type test model tests."""
        from rhosocial.activerecord.testsuite.feature.basic.fixtures.models import TypeTest
        models_and_tables = [
            (TypeTest, "type_tests"),
        ]
