    ...
    if env_config_path and os.path.exists(env_config_path):
        ...
        if not os.path.exists(config_path):
            raise FileNotFoundError(
                ...
                "Either set MYSQL_SCENARIOS_CONFIG_PATH environment variable to point to a valid YAML file "
...
def _apply_scenario_filter():
    ...
    local override (MYSQL_ACTIVE_SCENARIOS). It contains comma-separated full
    scenario names (e.g., "mysql_97,mysql_80").
    """
