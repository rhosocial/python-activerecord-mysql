# tests/rhosocial/activerecord_mysql_test/query/mysql/test_mysql_json_expressions.py
"""Test JSON expression functionality in ActiveQuery for MySQL."""
import json

import pytest

from rhosocial.activerecord_test.query.utils import create_json_test_fixtures
