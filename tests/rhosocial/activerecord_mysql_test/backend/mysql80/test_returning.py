# tests/rhosocial/activerecord_mysql_test/backend/mysql80/test_returning.py
from unittest.mock import patch, MagicMock

import pytest

from rhosocial.activerecord.backend import ReturningNotSupportedError
from rhosocial.activerecord.backend.impl.mysql.backend import MySQLBackend
from rhosocial.activerecord.backend.impl.mysql.dialect import MySQLReturningHandler
