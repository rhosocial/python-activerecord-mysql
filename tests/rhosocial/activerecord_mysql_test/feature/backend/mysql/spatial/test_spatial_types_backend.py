# tests/rhosocial/activerecord_mysql_test/feature/backend/mysql/spatial/test_spatial_types_backend.py
"""
...
class TestMySQLSpatialTypeBackend:
    ...
    def test_format_spatial_literal_without_srid(self, mysql_backend):
        ...
        result = mysql_backend.execute("SELECT ST_AsText(location) as wkt FROM test_spatial_literal WHERE id = 1")
    ...
    def test_format_create_spatial_index(self, mysql_backend):
        ...
        result = mysql_backend.execute("SELECT COUNT(*) as cnt FROM test_spatial_idx")
