# tests/rhosocial/activerecord_mysql_test/feature/backend/extensions/test_fulltext_index.py
"""
...
class TestFullTextProtocol:
    ...
    def test_match_against_expression(self):
        ...
        expr = MySQLMatchAgainstExpression(
            dialect, columns=["title", "content"], search_string="database", mode="BOOLEAN"
        )
    ...
    def test_match_against_with_alias(self):
        ...
        expr = MySQLMatchAgainstExpression(dialect, columns=["title", "content"], search_string="test")
