# tests/rhosocial/activerecord_mysql_test/feature/mixins/test_combined_articles.py
"""
Test combined article functionality (combining multiple mixins) for MySQL backend.
