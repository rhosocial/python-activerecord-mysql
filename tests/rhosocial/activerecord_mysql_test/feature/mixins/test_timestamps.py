# tests/rhosocial/activerecord_mysql_test/feature/mixins/test_timestamps.py
"""
This is a "bridge" file for the mixins features test group.
...
from rhosocial.activerecord.testsuite.feature.mixins.conftest import (
    timestamped_article_fixtures,
    soft_deletable_article_fixtures,
    locked_article_fixtures,
    combined_article_fixtures,
)
