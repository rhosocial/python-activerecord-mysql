# tests/rhosocial/activerecord_mysql_test/feature/connection/test_connection_pool_concurrent.py
"""
Concurrent connection pool tests for MySQL backend.
...
class TestBackendPoolConcurrent:
    ...
    def test_concurrent_connections_are_distinct(self, mysql_pool: BackendPool):
    ...
    def test_concurrent_transactions_isolated(self, mysql_pool_with_tables: BackendPool):
...
class TestAsyncBackendPoolConcurrent:
    ...
    @pytest.mark.asyncio
    async def test_concurrent_connections_are_distinct(self, async_mysql_pool: AsyncBackendPool):
    ...
    @pytest.mark.asyncio
    async def test_concurrent_operations_no_deadlock(self, async_mysql_pool_with_tables: AsyncBackendPool):
        """Verify that concurrent async operations don't cause deadlock."""
        pool = async_mysql_pool_with_tables
        num_concurrent = 4
        results: Dict[int, List[Any]] = {}
    ...
    @pytest.mark.asyncio
    async def test_concurrent_with_semaphore_limit(self, async_mysql_pool: AsyncBackendPool):
