#!/usr/bin/env bash
# ===========================================================================
# demo_all.sh — batch migration (--all) for MySQL
#
# Scenarios:
...
#     PYTHONPATH=src \
#     bash src/rhosocial/activerecord/backend/impl/mysql/examples/named_migrations/demo_all.sh
# ===========================================================================
set -euo pipefail
...
rm -f "$STORE"
echo "=== Batch Migration (--all) Complete for MySQL ==="