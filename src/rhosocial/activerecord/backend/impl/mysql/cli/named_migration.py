# src/rhosocial/activerecord/backend/impl/mysql/cli/named_migration.py
"""named-migration subcommand — MySQL adapter for the shared CLI helper."""
...
End-to-end demo scripts with UP/DOWN round-trip verification:
  https://github.com/rhosocial/python-activerecord-mysql/tree/main/src/rhosocial/activerecord/backend/impl/mysql/examples/named_migrations
