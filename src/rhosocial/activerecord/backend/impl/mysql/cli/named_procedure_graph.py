# src/rhosocial/activerecord/backend/impl/mysql/cli/named_procedure_graph.py
...
Usage:
    $ python -m rhosocial.activerecord.backend.impl.mysql named-procedure-graph run \
        myapp.npg.monthly_report \
        --params '{"month": "2026-04"}'

    $ python -m rhosocial.activerecord.backend.impl.mysql named-procedure-graph list \
        myapp.npg

    $ python -m rhosocial.activerecord.backend.impl.mysql named-procedure-graph validate \
        myapp.npg.monthly_report
"""
